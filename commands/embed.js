...
module.exports = {
    ...
    async execute(interaction) {
        ...
        var embed = new EmbedBuilder()
            ...
            .setDescription(`Due to constant raids, you are required to verify your Minecraft account to continue to our server. Read our FAQ below.

            **FAQ**
            
            **Q: What is this verification system?**
            
            > A: This verification system is a way to prevent bots and scammers from joining our server. It is also a way to link your Discord account to your Minecraft account to prevent alts being used in activities such as giveaways and drop parties. 
